...
feature.callbackQuery(startCheckCallback, logHandle('callback-query-user-panel'), userPanel);
feature.callbackQuery(showPhotosCallback, logHandle('callback-query-show-photos'), showPhotos);
feature.callbackQuery(editPhotoCallbackData.filter(), logHandle('callback-query-edit-photo'), editPhotoPanel);
feature.callbackQuery(sendPhotosCallback, logHandle('callback-query-save-to-google'), saveToGoogle);
feature.callbackQuery(skipPhotoCallback, logHandle('callback-query-get-photo'), getPhotoAnswer);
